...
module.exports = (email, nome, id) => {
    ...
    const mail = {
       ...
       <tr>
       <td style="Margin:0;padding-top:15px;padding-bottom:15px;padding-left:20px;padding-right:20px;background-color:transparent" bgcolor="transparent" align="left">
       ...
       <tr>
       <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;padding-top:5px;font-size:0px"><img src="https://firebasestorage.googleapis.com/v0/b/magalhaesbd-c856e.appspot.com/o/logo_v.png?alt=media&amp;token=57874624-c31f-446b-af86-e33e72ef87c1" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="270" height="38"></td>
       </tr>
       </table></td>
       </tr>
       </table>
       ...
       Olá <b>${nome}</b>,<br/>
       Seu pedido <a href='magalhaesengenharia.com/loja/pedido/${id}'>#${id}</a> teve seu pagamento confirmado. Logo entraremos em contato para confirmar os dados de envio.
